...
paa_df.to_csv("./dataset/paa_stock_data_time_series.csv", sep=',', encoding='utf-8')
print("PAA sample: ")
print(paa_df.head())
...
sax_df.to_csv("./dataset/sax_stock_data_time_series.csv", sep=',', encoding='utf-8')
print("SAX sample: ")
sax_df.head()
...
one_d_df.to_csv("./dataset/one_d_sax_stock_data_time_series.csv", sep=',', encoding='utf-8')
print("1D SAX sample: ")
one_d_df.head()
